...
export default function AppBar() {
  return (
    <div className="flex h-16 items-center text-neutral-50 bg-cyan-400">
      <a href="" className="ml-6 flex grow items-center">
      ...
      <a href="" className="mr-6 ml-6 h-10 w-10 overflow-clip flex justify-center items-center bg-cyan-400 rounded-full border-4 border-neutral-50 text-center">
